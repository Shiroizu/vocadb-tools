...
def test_parse_date_iso_with_ms() -> None:
    assert (
        str(parse_date("2025-09-29T04:32:04.89")) == "2025-09-29 04:32:04.890000+00:00"
    )
...
def test_parse_date_with_ms_and_z() -> None:
    assert (
        str(parse_date("2025-09-29T23:19:37.25Z")) == "2025-09-29 23:19:37.250000+00:00"
    )


def test_parse_date_three_digit_ms() -> None:
    assert (
        str(parse_date("2025-09-28T12:46:59.327")) == "2025-09-28 12:46:59.327000+00:00"
    )


def test_parse_date_with_positive_offset() -> None:
    assert str(parse_date("2025-07-21T02:00:00+02:00")) == "2025-07-21 00:00:00+00:00"
